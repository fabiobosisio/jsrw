...
console.log("JSRW v0.1.0")
console.log("")
console.log("JSRW is a command line JSON reader and editor")
console.log("")
console.log("Usage:")
console.log("    node jsrw.js <file> init <value>")
console.log("    node jsrw.js <file> <path>... <mode> <op>")
console.log("    node jsrw.js help")
console.log("")
console.log("Help:")
...
console.log("")
console.log("Value:")
console.log("    {}    Starts a JSON file with an empty object")
console.log("    |")
console.log("    []    Starts a JSON file with an empty array")
console.log("")
console.log("Path:")
...
console.log("")
console.log("    https://github.com/fabiobosisio/jsrw")
console.log("")
console.log("    Please report bugs at <https://github.com/fabiobosisio/jsrw/blob/master/README.md>")
console.log("")
}
